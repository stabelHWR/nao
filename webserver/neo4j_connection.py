...
class Neo4jConnection:
    def __init__(self):
        self.__uri = "neo4j://localhost:7999"
        self.__user = "neo4j"
    ...
    def query(self, query: str, parameters=None, field_name: str =None)->list:
        """Führe eine Abfrage aus und gib die Ergebnisse zurück."""
        if not parameters:
            parameters = {}
        result = self.__session.run(query, parameters)
        if field_name is not None :
            query_results = [record[field_name] for record in result]
        else:
            query_results = [record for record in result]
    ...
    def fill_database(self):
        ...
        self.execute_query(query6)
        self.execute_query(query7)
        self.execute_query(query8)
        self.execute_query(query9)
        self.execute_query(query10)
        self.execute_query(query11)
        self.execute_query(query12)
        self.execute_query(query13)
        self.execute_query(query14)
        self.execute_query(query15)
        self.execute_query(query16)
        self.execute_query(query17)
        self.execute_query(query18)
        self.execute_query(query19)
        self.execute_query(query20)
        self.execute_query(query21)
        self.execute_query(query22)
        self.execute_query(query23)
        self.execute_query(query24)
